...
### Декоратор логирования (src/decorators.py)
Реализован декоратор `@log(filename)`, который автоматически логирует выполнение функций:
* Если `filename` передан — логи записываются в указанный файл.
* Если `filename` не задан — логи выводятся в консоль.
* Успешное выполнение функции фиксируется записью: `имя_функции ok`.
* Ошибки внутри функции логируются с указанием типа ошибки и переданных аргументов (`Inputs`).