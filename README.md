...
Добавлен параметризованный декоратор `@log`, который автоматически логирует начало, успешное завершение функции или возникшие ошибки. Если передан аргумент `filename`, логи записываются в файл, иначе — выводятся в консоль.